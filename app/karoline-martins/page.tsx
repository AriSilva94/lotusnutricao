...
const profile = doctors.find((doctor) => doctor.slug === "karoline-martins");

export const metadata: Metadata = {
  title: "Dra. Karoline Martins | Nutricionista em Jundiaí",
  description:
    "Perfil da Dra. Karoline Martins na Clínica Lótus em Jundiaí: nutrição colaborativa com foco em transformação, clínica, esportiva e exames laboratoriais.",
};

export default function KarolinePage() {
  return (
    <main id="content" className="mx-auto w-full max-w-4xl px-4 py-10 sm:px-6 sm:py-14">
      ...
      <section className="mt-6 rounded-2xl border border-[#d8d5ce] bg-white p-6">
        <h2 className="text-xl font-semibold text-[#2f3a32]">Recursos para pacientes</h2>
        <ul className="mt-4 space-y-2 text-sm leading-7 text-[#445248]">
